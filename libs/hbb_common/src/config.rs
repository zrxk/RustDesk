xQ5CXji0uJFN9Sqa9qaI7MKr8VHzEILPlhaRevxvWeo=use std::{
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["990091.xyz"];
pub const PUBLIC_RS_PUB_KEY: &str = "xQ5CXji0uJFN9Sqa9qaI7MKr8VHzEILPlhaRevxvWeo=";
